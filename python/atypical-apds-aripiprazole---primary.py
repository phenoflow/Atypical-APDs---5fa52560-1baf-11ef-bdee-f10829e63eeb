...
codes = [{"code":"87944020","system":"multilex"},{"code":"91143020","system":"multilex"},{"code":"91139020","system":"multilex"},{"code":"87946020","system":"multilex"},{"code":"91141020","system":"multilex"}];
REQUIRED_CODES = 1;
